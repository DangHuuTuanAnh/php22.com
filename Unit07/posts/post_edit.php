    ...
    <div class="container">
        ...
        <form action="post_edit_process.php" method="POST" role="form" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="" placeholder="" name="description" value="<?php echo $posts['description'] ?>">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <textarea type="text" class="form-control" id="summernote" placeholder="" name="content"><?php echo $posts['content'] ?></textarea>
            </div>
            <div class="form-group">
                <label for="">Danh mục</label>
                <select class="form-control" id="" placeholder="" name="category_id">
                    <?php foreach ($categories as $category) {?>
                        <option value="<?php echo $category['id'] ?>"<?php if ($category['id']==$posts['category_id']) {
                            echo "selected";
            ...
            <div class="form-group">
                ...
                <select class="form-control" id="" placeholder="" name="user_id">
                    <?php foreach ($users as $user) {?>
                        <option value="<?php echo $user['id'] ?>"<?php if ($user['id']==$posts['user_id']) {
                            echo "selected";
