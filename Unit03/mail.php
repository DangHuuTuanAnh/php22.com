<?php 
	function send_email($email_recive,$name,$contents,$subject){
        ...
        $mail->SetFrom("tuananhlg97@gmail.com", "Tuấn Anh"); // Thông tin người gửi
        $mail->AddReplyTo("tuananhlg97@gmail.com","Tuấn Anh");// Ấn định email sẽ nhận khi người dùng reply lại.
